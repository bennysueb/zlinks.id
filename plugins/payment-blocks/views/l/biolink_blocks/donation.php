            ...
            <div class="modal-body">
                <form id="<?= 'donation_form_' . $data->link->biolink_block_id ?>" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="<?= 'donation_form_amount_' . $data->link->biolink_block_id ?>"><?= l('biolink_donation_modal.amount') ?></label>
                    ...
                    <?php if($data->link->settings->allow_message): ?>
                        <div class="form-group">
                            <label for="<?= 'donation_form_message_' . $data->link->biolink_block_id ?>"><?= l('biolink_donation_modal.message') ?></label>
                    ...
                    <div class="text-center mt-4">
                        <button type="submit" name="submit" class="btn btn-block btn-lg btn-primary" data-is-ajax><?= l('biolink_donation_modal.submit') ?></button>
                    </div>
                </form>
            </div>
